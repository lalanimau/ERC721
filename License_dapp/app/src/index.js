...
if (window.location.hostname == 'licensetoken.atchai.com') {
  contract_address = '0x9e17be3d288ba5365efed11c3fc20ff6318d90c5';  //ropsten
  server_address = 'http://licensetoken.atchai.com'
  network_id = 3 // ropsten - ethereum network ID
}
// dev
else {
  contract_address = '0x9e17be3d288ba5365efed11c3fc20ff6318d90c5';  //dev
  server_address = 'http://localhost:3001'
  network_id = "*" // ganache - ethereum network ID
}
...
function startApp(web3js) {
  ...
  $('.verify').on('click', function() {
    ...
    if (challenge[1].value) {
      console.log("success",challenge[1].value);
